...
#if !defined(TMR2REGISTERS_HPP)
#define TMR2REGISTERS_HPP
...
namespace AT32F407xx_v2
{
    struct TMR2
    {
        struct CTRL1 : public Register<0x40000000, 32, ReadWriteMode>
        {
            struct PMEN : public RegisterField<CTRL1, 10, 1, ReadWriteMode>
            {
                using Value0 = FieldValue<PMEN, 0U>;
                using Value1 = FieldValue<PMEN, 1U>;
            };
        ...
        struct CTRL2 : public Register<0x40000004, 32, ReadWriteMode>
        {
        ...
        struct STCTRL : public Register<0x40000008, 32, ReadWriteMode>
        {
        ...
        struct IDEN : public Register<0x4000000C, 32, ReadWriteMode>
        {
        ...
        struct ISTS : public Register<0x40000010, 32, ReadWriteMode>
        {
        ...
        struct SWEVT : public Register<0x40000014, 32, ReadWriteMode>
        {
        ...
        struct CM1_OUTPUT : public Register<0x40000018, 32, ReadWriteMode>
        {
        ...
        struct CM1_INPUT : public Register<0x40000018, 32, ReadWriteMode>
        {
        ...
        struct CM2_OUTPUT : public Register<0x4000001C, 32, ReadWriteMode>
        {
        ...
        struct CM2_INPUT : public Register<0x4000001C, 32, ReadWriteMode>
        {
        ...
        struct CCTRL : public Register<0x40000020, 32, ReadWriteMode>
        {
        ...
        struct CVAL : public Register<0x40000024, 32, ReadWriteMode>
        {
            struct CVALField : public RegisterField<CVAL, 0, 32, ReadWriteMode>
            {
            };

        };

        struct DIV : public Register<0x40000028, 32, ReadWriteMode>
        {
        ...
        struct PR : public Register<0x4000002C, 32, ReadWriteMode>
        {
            struct PRField : public RegisterField<PR, 0, 32, ReadWriteMode>
            {
            };

        };

        struct C1DT : public Register<0x40000034, 32, ReadWriteMode>
        {
            struct C1DTField : public RegisterField<C1DT, 0, 32, ReadWriteMode>
            {
            };

        };

        struct C2DT : public Register<0x40000038, 32, ReadWriteMode>
        {
            struct C2DTField : public RegisterField<C2DT, 0, 32, ReadWriteMode>
            {
            };

        };

        struct C3DT : public Register<0x4000003C, 32, ReadWriteMode>
        {
            struct C3DTField : public RegisterField<C3DT, 0, 32, ReadWriteMode>
            {
            };

        };

        struct C4DT : public Register<0x40000040, 32, ReadWriteMode>
        {
            struct C4DTField : public RegisterField<C4DT, 0, 32, ReadWriteMode>
            {
            };

        };

        struct DMACTRL : public Register<0x40000048, 32, ReadWriteMode>
        {
        ...
        struct DMADT : public Register<0x4000004C, 32, ReadWriteMode>
        {
...
#endif //#if !defined(TMR2REGISTERS_HPP)
