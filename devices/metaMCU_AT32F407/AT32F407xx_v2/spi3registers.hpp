...
namespace AT32F407xx_v2
{
    struct SPI3
    {
        struct CTRL1 : public Register<0x40003C00, 32, ReadWriteMode>
        {
        ...
        struct CTRL2 : public Register<0x40003C04, 32, ReadWriteMode>
        {
        ...
        struct STS : public Register<0x40003C08, 32, ReadWriteMode>
        {
        ...
        struct DT : public Register<0x40003C0C, 32, ReadWriteMode>
        {
        ...
        struct CPOLY : public Register<0x40003C10, 32, ReadWriteMode>
        {
        ...
        struct RCRC : public Register<0x40003C14, 32, ReadMode>
        {
        ...
        struct TCRC : public Register<0x40003C18, 32, ReadMode>
        {
        ...
        struct I2SCTRL : public Register<0x40003C1C, 32, ReadWriteMode>
        {
        ...
        struct I2SCLK : public Register<0x40003C20, 32, ReadWriteMode>
        {
