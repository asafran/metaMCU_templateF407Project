...
namespace AT32F407xx_v2
{
    struct I2C3
    {
        struct CTRL1 : public Register<0x40015C00, 32, ReadWriteMode>
        {
        ...
        struct CTRL2 : public Register<0x40015C04, 32, ReadWriteMode>
        {
        ...
        struct OADDR1 : public Register<0x40015C08, 32, ReadWriteMode>
        {
        ...
        struct OADDR2 : public Register<0x40015C0C, 32, ReadWriteMode>
        {
        ...
        struct DT : public Register<0x40015C10, 32, ReadWriteMode>
        {
        ...
        struct STS1 : public Register<0x40015C14, 32, ReadWriteMode>
        {
        ...
        struct STS2 : public Register<0x40015C18, 32, ReadMode>
        {
        ...
        struct CLKCTRL : public Register<0x40015C1C, 32, ReadWriteMode>
        {
        ...
        struct TMRISE : public Register<0x40015C20, 32, ReadWriteMode>
        {
