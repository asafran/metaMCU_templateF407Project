...
namespace AT32F407xx_v2
{
    struct SPI4
    {
        struct CTRL1 : public Register<0x40004000, 32, ReadWriteMode>
        {
        ...
        struct CTRL2 : public Register<0x40004004, 32, ReadWriteMode>
        {
        ...
        struct STS : public Register<0x40004008, 32, ReadWriteMode>
        {
        ...
        struct DT : public Register<0x4000400C, 32, ReadWriteMode>
        {
        ...
        struct CPOLY : public Register<0x40004010, 32, ReadWriteMode>
        {
        ...
        struct RCRC : public Register<0x40004014, 32, ReadMode>
        {
        ...
        struct TCRC : public Register<0x40004018, 32, ReadMode>
        {
        ...
        struct I2SCTRL : public Register<0x4000401C, 32, ReadWriteMode>
        {
        ...
        struct I2SCLK : public Register<0x40004020, 32, ReadWriteMode>
        {
