...
#if !defined(TMR7REGISTERS_HPP)
#define TMR7REGISTERS_HPP
...
namespace AT32F407xx_v2
{
    struct TMR7
    {
        struct CTRL1 : public Register<0x40001400, 32, ReadWriteMode>
        {
        ...
        struct CTRL2 : public Register<0x40001404, 32, ReadWriteMode>
        {
        ...
        struct IDEN : public Register<0x4000140C, 32, ReadWriteMode>
        {
        ...
        struct ISTS : public Register<0x40001410, 32, ReadWriteMode>
        {
        ...
        struct SWEVT : public Register<0x40001414, 32, ReadWriteMode>
        {
        ...
        struct CVAL : public Register<0x40001424, 32, ReadWriteMode>
        {
        ...
        struct DIV : public Register<0x40001428, 32, ReadWriteMode>
        {
        ...
        struct PR : public Register<0x4000142C, 32, ReadWriteMode>
        {
...
#endif //#if !defined(TMR7REGISTERS_HPP)
