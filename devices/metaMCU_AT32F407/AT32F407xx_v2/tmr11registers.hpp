...
#if !defined(TMR11REGISTERS_HPP)
#define TMR11REGISTERS_HPP
...
namespace AT32F407xx_v2
{
    struct TMR11
    {
        struct CTRL1 : public Register<0x40015400, 32, ReadWriteMode>
        {
        ...
        struct IDEN : public Register<0x4001540C, 32, ReadWriteMode>
        {
        ...
        struct ISTS : public Register<0x40015410, 32, ReadWriteMode>
        {
        ...
        struct SWEVT : public Register<0x40015414, 32, ReadWriteMode>
        {
        ...
        struct CM1_OUTPUT : public Register<0x40015418, 32, ReadWriteMode>
        {
        ...
        struct CM1_INPUT : public Register<0x40015418, 32, ReadWriteMode>
        {
        ...
        struct CCTRL : public Register<0x40015420, 32, ReadWriteMode>
        {
        ...
        struct CVAL : public Register<0x40015424, 32, ReadWriteMode>
        {
        ...
        struct DIV : public Register<0x40015428, 32, ReadWriteMode>
        {
        ...
        struct PR : public Register<0x4001542C, 32, ReadWriteMode>
        {
        ...
        struct C1DT : public Register<0x40015434, 32, ReadWriteMode>
        {
...
#endif //#if !defined(TMR11REGISTERS_HPP)
