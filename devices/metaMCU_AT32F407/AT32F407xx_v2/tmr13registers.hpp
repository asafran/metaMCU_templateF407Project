...
#if !defined(TMR13REGISTERS_HPP)
#define TMR13REGISTERS_HPP
...
namespace AT32F407xx_v2
{
    struct TMR13
    {
        struct CTRL1 : public Register<0x40001C00, 32, ReadWriteMode>
        {
        ...
        struct IDEN : public Register<0x40001C0C, 32, ReadWriteMode>
        {
        ...
        struct ISTS : public Register<0x40001C10, 32, ReadWriteMode>
        {
        ...
        struct SWEVT : public Register<0x40001C14, 32, ReadWriteMode>
        {
        ...
        struct CM1_OUTPUT : public Register<0x40001C18, 32, ReadWriteMode>
        {
        ...
        struct CM1_INPUT : public Register<0x40001C18, 32, ReadWriteMode>
        {
        ...
        struct CCTRL : public Register<0x40001C20, 32, ReadWriteMode>
        {
        ...
        struct CVAL : public Register<0x40001C24, 32, ReadWriteMode>
        {
        ...
        struct DIV : public Register<0x40001C28, 32, ReadWriteMode>
        {
        ...
        struct PR : public Register<0x40001C2C, 32, ReadWriteMode>
        {
        ...
        struct C1DT : public Register<0x40001C34, 32, ReadWriteMode>
        {
...
#endif //#if !defined(TMR13REGISTERS_HPP)
