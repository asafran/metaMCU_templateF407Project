...
#if !defined(TMR10REGISTERS_HPP)
#define TMR10REGISTERS_HPP
...
namespace AT32F407xx_v2
{
    struct TMR10
    {
        struct CTRL1 : public Register<0x40015000, 32, ReadWriteMode>
        {
        ...
        struct IDEN : public Register<0x4001500C, 32, ReadWriteMode>
        {
        ...
        struct ISTS : public Register<0x40015010, 32, ReadWriteMode>
        {
        ...
        struct SWEVT : public Register<0x40015014, 32, ReadWriteMode>
        {
        ...
        struct CM1_OUTPUT : public Register<0x40015018, 32, ReadWriteMode>
        {
        ...
        struct CM1_INPUT : public Register<0x40015018, 32, ReadWriteMode>
        {
        ...
        struct CCTRL : public Register<0x40015020, 32, ReadWriteMode>
        {
        ...
        struct CVAL : public Register<0x40015024, 32, ReadWriteMode>
        {
        ...
        struct DIV : public Register<0x40015028, 32, ReadWriteMode>
        {
        ...
        struct PR : public Register<0x4001502C, 32, ReadWriteMode>
        {
        ...
        struct C1DT : public Register<0x40015034, 32, ReadWriteMode>
        {
...
#endif //#if !defined(TMR10REGISTERS_HPP)
