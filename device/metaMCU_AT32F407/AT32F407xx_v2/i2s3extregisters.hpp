...
namespace AT32F407xx_v2
{
    struct I2S3_EXT
    {
        struct CTRL1 : public Register<0x40017000, 32, ReadWriteMode>
        {
        ...
        struct CTRL2 : public Register<0x40017004, 32, ReadWriteMode>
        {
        ...
        struct STS : public Register<0x40017008, 32, ReadWriteMode>
        {
        ...
        struct DT : public Register<0x4001700C, 32, ReadWriteMode>
        {
        ...
        struct CPOLY : public Register<0x40017010, 32, ReadWriteMode>
        {
        ...
        struct RCRC : public Register<0x40017014, 32, ReadMode>
        {
        ...
        struct TCRC : public Register<0x40017018, 32, ReadMode>
        {
        ...
        struct I2SCTRL : public Register<0x4001701C, 32, ReadWriteMode>
        {
        ...
        struct I2SCLK : public Register<0x40017020, 32, ReadWriteMode>
        {
