...
namespace AT32F407xx_v2
{
    struct SPI1
    {
        struct CTRL1 : public Register<0x40013000, 32, ReadWriteMode>
        {
        ...
        struct CTRL2 : public Register<0x40013004, 32, ReadWriteMode>
        {
        ...
        struct STS : public Register<0x40013008, 32, ReadWriteMode>
        {
        ...
        struct DT : public Register<0x4001300C, 32, ReadWriteMode>
        {
        ...
        struct CPOLY : public Register<0x40013010, 32, ReadWriteMode>
        {
        ...
        struct RCRC : public Register<0x40013014, 32, ReadMode>
        {
        ...
        struct TCRC : public Register<0x40013018, 32, ReadMode>
        {
        ...
        struct I2SCTRL : public Register<0x4001301C, 32, ReadWriteMode>
        {
        ...
        struct I2SCLK : public Register<0x40013020, 32, ReadWriteMode>
        {
